<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InspectionDayTable.aspx.cs"
    Inherits="Citic_Web.InspectionFrequency.InspectionDayTable" %>
            ...
            <x:Panel ID="Panel3" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
                ...
                <Items>
                    <x:Grid ID="G_DayTabel" runat="server" EnableRowNumber="true" Title="2、具体情况" EnableBackgroundColor="true"
                        ForceFitAllTime="false" EnableColumnLines="true">
                        <GroupColumns>
                        </GroupColumns>
                        <Columns>
                            <x:BoundField HeaderText="区域中心" ColumnID="Area" DataField="Area" />
                            ...
                            <%--<x:WindowField WindowID="DayUpdate" HeaderText="经销店名称" ToolTip="编辑" DataTextFormatString="{0}"
                                DataIFrameUrlFields="ID" DataTextField="DealerName" DataIFrameUrlFormatString="InspectionDayTableUpdate.aspx?ID={0}"
                            ...
                            <x:BoundField HeaderText="视频-汽车处理结果" ColumnID="MainProblem_1_Results" DataField="MainProblem_1_Results" />
                            ...
                            <x:BoundField HeaderText="视频-风控处理结果" ColumnID="MainProblem_2_Results" DataField="MainProblem_2_Results" />
                            ...
                            <x:BoundField HeaderText="视频-管理处理结果" ColumnID="MainProblem_3_Results" DataField="MainProblem_3_Results" />
                            ...
                            <x:BoundField HeaderText="总账-汽车处理结果" ColumnID="QuartersLedger_1_Results" DataField="QuartersLedger_1_Results" />
                            ...
                            <x:BoundField HeaderText="持续-汽车处理结果" ColumnID="Continue_1_Results" DataField="Continue_1_Results" />
