<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMenu.aspx.cs" Inherits="Citic_Web.SystemSet.EditMenu" %>
...
<body>
    <form id="FormEditMenu" runat="server">
    <x:PageManager ID="PMEditMenu" AutoSizePanelID="Panel1" runat="server" />
            ...
            <x:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false">
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                        ...
                        <Items>
                            <x:Label ID="lblMenuName" Label="模块名" Text="" runat="server" />
