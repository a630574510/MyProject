<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSupervisor.aspx.cs"
    Inherits="Citic_Web.BasicInfoManagement.AddSupervisor" %>
                        ...
                        <x:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="5px" ShowBorder="false"
                            ...
                            <Items>
                                <x:TextBox ID="txt_Name" runat="server" Label="监管员姓名" Required="true" RequiredMessage="请输入姓名"
                                    Text="" Width="200px" EnableAjax="true" AjaxLoadingType="Default" />
                                ...
                                <x:TextBox ID="txt_IDCard" runat="server" Label="身份证号" Text="" Regex="[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}(\d|x|X)"
                                    Width="200px" Required="true" RequiredMessage="请输入身份证号" AutoPostBack="true" OnTextChanged="txt_IDCard_TextChanged" />
                                ...
                                <x:DropDownList runat="server" Label="学历" ID="ddl_Education" Width="100px" AutoPostBack="false"
                                    CompareType="String" CompareValue="" CompareOperator="NotEqual" CompareMessage="请选择学历！">
                                    <x:ListItem Text="请选择" Value="" Selected="true" />
                                ...
                                <x:TextBox ID="num_LinkPhone" runat="server" Label="电话" Text="" Width="200px" />
                                <x:TextBox ID="num_QQ" runat="server" Label="QQ" Text="" Width="200px" />
                                ...
                                <x:TextBox ID="num_UrgencyPhone" runat="server" Label="紧急联系人电话" Text="" Width="200px" />
                            </Items>
                        </x:SimpleForm>
                    </Items>
                </x:Panel>
