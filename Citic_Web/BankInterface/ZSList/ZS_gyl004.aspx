<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZS_gyl004.aspx.cs" Inherits="Citic_Web.BankInterface.ZSList.ZS_gyl004" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="浙商监管协议信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询协议条件" EnableBackgroundColor="true">
                        <Toolbars>
