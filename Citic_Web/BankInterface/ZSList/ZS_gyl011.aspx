<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZS_gyl011.aspx.cs" Inherits="Citic_Web.BankInterface.ZSList.ZS_gyl011" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>质押物价格调整通知书详情查询</title>
</head>
<body>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="浙商价格调整通知信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询通知条件" EnableBackgroundColor="true">
                        <Toolbars>
            ...
            <x:Panel ID="Panel3" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true"
                ...
                <Items>
                    <x:Grid ID="G_DealerName" runat="server" Title="详细信息" ShowBorder="true" ShowHeader="false"
                        ...
                        <Columns>
                            <x:BoundField HeaderText="客户名称" Width="200px" DataField="custName" TextAlign="Center" />
                            <x:WindowField WindowID="W_ShowSCF" HeaderText="开票日期" DataTextField="loanstDate"
                                ToolTip="详细信息" DataIFrameUrlFields="id" DataIFrameUrlFormatString="ZX_ShowSCF.aspx?id={0}&type=DLCDLMLQ&clss=ZX" />
                            <x:BoundField HeaderText="汇票总数" DataField="loanstList" TextAlign="Center" />
