<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDealer.aspx.cs" Inherits="Citic_Web.DealerManagement.DealerInfo.EditDealer" %>
            ...
            <Toolbars>
                <x:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <x:Button ID="btn_Close" runat="server" Text="关闭页面" OnClick="btn_Close_Click" Icon="Cancel">
                        </x:Button>
                    </Items>
                </x:Toolbar>
            </Toolbars>
                        ...
                        <x:SimpleForm ID="sf_DealerInfo" runat="server" AutoScroll="true" BoxFlex="1" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
                            ...
                            <Items>
                                ...
                                <x:DropDownList ID="ddl_GoffworkTime" runat="server" Label="下班时间" Width="300px">
                                    ...
                                    <x:ListItem Value="21:00" Text="21:00" />
                    ...
                    <Items>
                        ...
                        <x:Grid ID="grid_List1" runat="server" EnableRowNumber="true" BoxFlex="1"
                            ...
                            <Columns>
                                ...
                                <x:BoundField ColumnID="bf_LinkmanName1" DataField="LinkmanName" DataFormatString="{0}"
                                    HeaderText="名称" />
                                <x:BoundField ColumnID="bf_ParentName1" DataField="Phone" DataFormatString="{0}"
                                    HeaderText="电话" />
                                <x:BoundField ColumnID="bf_Fax1" DataField="Fax" DataFormatString="{0}"
                                    HeaderText="传真" />
                                <x:BoundField ColumnID="bf_Email1" DataField="Email" DataFormatString="{0}"
                                    HeaderText="邮箱" />
                            </Columns>
                        </x:Grid>
                    </Items>
                    ...
                    <Items>
                        ...
                        <x:Grid ID="grid_List2" runat="server" EnableRowNumber="true" BoxFlex="1" EnableTextSelection="true"
                            ...
                            <Columns>
                                <x:LinkButtonField ColumnID="link_Delete" ConfirmIcon="Warning" ConfirmTarget="Parent" Width="40px"
                                    ConfirmText="确定要删除？" ConfirmTitle="系统提示" Text="删除" CommandName="delete" HeaderText="删除" />
                                <x:BoundField ColumnID="bf_LinkmanName2" DataField="LinkmanName" DataFormatString="{0}"
                                    HeaderText="名称" />
                                <x:BoundField ColumnID="bf_ParentName2" DataField="Phone" DataFormatString="{0}"
                                    HeaderText="电话" />
                                <x:BoundField ColumnID="bf_Fax2" DataField="Fax" DataFormatString="{0}"
                                    HeaderText="传真" />
                                <x:BoundField ColumnID="bf_Email2" DataField="Email" DataFormatString="{0}"
                                    HeaderText="邮箱" />
                            </Columns>
                        </x:Grid>
                    </Items>
