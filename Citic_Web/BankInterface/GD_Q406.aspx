<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GD_Q406.aspx.cs" Inherits="Citic_Web.BankInterface.GD_Q406" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
                Title="Panel">
                <Items>
                    <x:SimpleForm ID="SimpleForm1" runat="server" BodyPadding="5px" Title="查询信息" EnableBackgroundColor="true" LabelAlign="Right">
                        <Toolbars>
                        ...
                        <Items>
                            <x:DropDownList ID="ddl_JXS_ID" runat="server" Label="经销商" AutoPostBack="true" Width="300px"
                                OnSelectedIndexChanged="ddl_JXS_ID_SelectedIndexChanged">
                            </x:DropDownList>
            ...
            <x:Panel ID="Panel3" runat="server" BodyPadding="0px" ShowBorder="true" ShowHeader="true"
                ...
                <Items>
                    <x:Grid ID="G_Correct" runat="server" Title="详细信息" ShowBorder="true" ShowHeader="false"
                        EnableRowNumber="True" EnableTextSelection="true" EmptyText="<span style='color:Red;font-size:21px'>提示：车架号和合格证必须输入一项</br>请不要把<span style='color:Blue';>合格证当做车架号</span>,或者把<span style='color:Blue';>车架号当做合格证</span></br>否者就会出现<span style='color:Blue';>合格证不存在</span>的错误提示</br>当出现错误提示,请检查车架号或合格证是否输入正确</span>">
                        <Columns>
                            <x:BoundField HeaderText="经销商名称" DataField="JXS_NAME" Width="200px" />
