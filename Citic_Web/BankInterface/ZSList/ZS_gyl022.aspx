<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZS_gyl022.aspx.cs" Inherits="Citic_Web.BankInterface.ZSList.ZS_gyl022" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="浙商借据信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询借据条件" EnableBackgroundColor="true">
                        <Toolbars>
