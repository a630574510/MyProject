<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GD_DealerName_Select.aspx.cs"
    Inherits="Citic_Web.Car.GD_DealerName_Select" %>
            ...
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                ...
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询客户条件" EnableBackgroundColor="true">
                        ...
                        <Items>
                            <x:TextBox ID="txt_CUST_NAME" runat="server" Label="客户名称" Text="" Width="300px">
                            </x:TextBox>
                            <x:TextBox ID="txt_ORG_CODE" runat="server" Label="组织机构代码" Text="" Width="300px">
                            </x:TextBox>
                            <x:DropDownList ID="ddl_SelCUST_TYPE" runat="server" Label="客户类型" Width="300px">
