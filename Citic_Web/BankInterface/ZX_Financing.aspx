<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZX_Financing.aspx.cs" Inherits="Citic_Web.BankInterface.ZX_Financing" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="中信融资信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询融资条件" EnableBackgroundColor="true">
                        <Toolbars>
