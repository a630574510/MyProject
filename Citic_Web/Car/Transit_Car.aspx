    ...
    <x:Panel ID="Panel_Transit" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Form ID="Form2" runat="server" BodyPadding="5px" Title="查询条件" EnableBackgroundColor="true"
                LabelAlign="Right" LabelWidth="60px" Height="110px">
                <Toolbars>
                    ...
                    <x:FormRow>
                        <Items>
                            ...
                            <x:DropDownList ID="DDL_Number_Order" runat="server" Label="汇票号" ShowLabel="true"
                                Width="200px" AutoPostBack="false" Resizable="true">
                            </x:DropDownList>
                        </Items>
                    </x:FormRow>
            ...
            <x:Panel ID="Panel2" ShowBorder="True" ShowHeader="false" BoxFlex="1" Layout="Fit"
                runat="server">
                <Items>
                    <x:Grid ID="G_Car_Detail" runat="server" EnableRowNumber="true" Title="车辆详细信息" PageSize="15"
                        AllowPaging="false" EnableBackgroundColor="true" AllowCellEditing="true" ClicksToEdit="1"
                        DataKeyNames="Vin,KeyCount" EnableTextSelection="true">
                        <Toolbars>
                            <x:Toolbar ID="Toolbar1" runat="server">
                                <Items>
                                    <x:Button ID="Btn_Again_Bind" runat="server" Text="提交入库" OnClick="Btn_Again_Bind_Click"
                                        Icon="Tick" IconAlign="Right" Hidden="true">
                                    </x:Button>
                                    <x:Button ID="Btn_GD" runat="server" Text="提交光大入库" OnClick="Btn_GD_Click" Icon="Tick"
                                        IconAlign="Right" Hidden="true">
                                    </x:Button>
                        ...
                        <Columns>
                            ...
                            <x:RenderField HeaderText="车辆型号" FieldType="String" DataField="CarModel" Width="110px"
                                ...
                                <Editor>
                                    <x:TextBox ID="txtCarModel" runat="server" Readonly="true">
                                    </x:TextBox>
                                </Editor>
                            </x:RenderField>
                            <x:RenderField HeaderText="颜色" DataField="CarColor" FieldType="String" Width="50px"
                                ...
                                <Editor>
                                    <x:TextBox ID="txtCarColour" runat="server" Readonly="true">
                                    </x:TextBox>
                                </Editor>
                            </x:RenderField>
                            <x:RenderField HeaderText="发动机号" DataField="EngineNo" FieldType="String" Width="110px"
                                ...
                                <Editor>
                                    <x:TextBox ID="txtEngineNo" runat="server" Readonly="true">
                                    </x:TextBox>
                                </Editor>
                            </x:RenderField>
                            ...
                            <x:RenderField HeaderText="备注" DataField="Remarks" FieldType="String" Width="110px"
                                ...
                                <Editor>
                                    <x:TextBox ID="txtRemark" runat="server" Readonly="true">
                                    </x:TextBox>
                                </Editor>
                            </x:RenderField>
                        </Columns>
