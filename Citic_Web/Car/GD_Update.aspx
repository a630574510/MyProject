<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GD_Update.aspx.cs" Inherits="Citic_Web.Car.GD_Update" %>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
                Title="Panel">
                <Items>
                    <x:Form Title="查询车辆条件" BodyPadding="5px" runat="server" EnableBackgroundColor="true">
                        <Toolbars>
            ...
            <x:Panel ID="Panel3" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true"
                ...
                <Items>
                    <x:Form ID="Form2" runat="server" BodyPadding="5px" Title="详细信息" EnableBackgroundColor="true" LabelAlign="Right">
                        <Toolbars>
