                    ...
                    <Items>
                        <x:Panel ID="Panel2" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="txt_DealerName" runat="server" Label="经销商" Text="" Width="325px" AutoPostBack="true" OnTextChanged="txt_DealerName_TextChanged"></x:TextBox>
                        ...
                        <x:Panel ID="Panel3" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                            ...
                            <Items>
                                ...
                                <x:TextBox ID="txt_cf" runat="server" Label="Label" Text=""></x:TextBox>
                                <x:Label ID="Label5" runat="server" Text="审批时间：" CssClass="inline" CssStyle="padding-left:10px"></x:Label>
                                <x:DatePicker ID="dp_ApplyTimeSearch" runat="server" Width="120px"></x:DatePicker>
                                <x:Button ID="btn_Search" runat="server" Text="查询" Icon="SystemSearch" CssStyle="padding-left:10px" OnClick="btn_Search_Click" Visible="false"></x:Button>
                            </Items>
                        </x:Panel>
                    </Items>
                </x:SimpleForm>
                <x:Grid ID="grid_List" runat="server" EnableBackgroundColor="true" EnableTextSelection="true" EnableRowNumberPaging="true"
                    DataKeyNames="ID,DealerID,BankID,BrandID" BoxFlex="2" ShowHeader="false" ClicksToEdit="1" AllowCellEditing="true">
                    <Toolbars>
                    ...
                    <Columns>
                        <x:RenderCheckField ColumnID="check" Width="30px" />
                        <x:BoundField DataField="DealerName" HeaderText="经销商代码/经销商名称" TextAlign="Left" Width="300px" />
                        <x:BoundField DataField="BankName" HeaderText="合作行" TextAlign="Left" Width="200px" />
                        <x:BoundField DataField="BrandName" HeaderText="品牌" TextAlign="Left" Width="100px" />
                        ...
                        <x:RenderField Width="100px" ColumnID="ApplyTime" DataField="ApplyTime" FieldType="Date" Renderer="Date"
                            HeaderText="审批时间" TextAlign="Left">
                            <Editor>
                        ...
                        <x:RenderField Width="150px" ColumnID="Remark" DataField="Remark" FieldType="String"
                            ...
                            <Editor>
                                <x:TextArea ID="txt_Remark" runat="server" Height="50px" Text=""></x:TextArea>
                            </Editor>
                        </x:RenderField>
                    </Columns>
                </x:Grid>
