<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZS_gyl017.aspx.cs" Inherits="Citic_Web.BankInterface.ZSList.ZS_gyl017" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>出质入库通知书详情查询</title>
</head>
<body>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="浙商入库通知书信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询通知书条件" EnableBackgroundColor="true">
                        <Toolbars>
