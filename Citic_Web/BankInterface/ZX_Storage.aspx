<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZX_Storage.aspx.cs" Inherits="Citic_Web.BankInterface.ZX_Storage" %>
...
<body>
    ...
    <x:Panel ID="Panel1" runat="server" BodyPadding="0px" ShowBorder="false" ShowHeader="false"
        ...
        <Items>
            <x:Panel ID="Panel2" runat="server" BodyPadding="5px" ShowBorder="false" ShowHeader="true"
                Title="中信仓库信息" EnableBackgroundColor="true">
                <Items>
                    <x:SimpleForm ID="SimpleForm" runat="server" BodyPadding="5px" Title="查询仓库条件" EnableBackgroundColor="true">
                        <Toolbars>
            ...
            <x:Panel ID="Panel3" runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true"
                ...
                <Items>
                    <x:Grid ID="G_DealerName" runat="server" Title="详细信息" ShowBorder="false" ShowHeader="false"
                        EnableTextSelection="true" ForceFitAllTime="true">
                        <Columns>
                            <x:BoundField HeaderText="客户名称" DataField="custName" TextAlign="Center" />
                            <x:WindowField WindowID="W_ShowSCF" HeaderText="客户名称" DataTextField="custName" ToolTip="详细信息"
                                DataIFrameUrlFields="id" DataIFrameUrlFormatString="ZX_ShowSCF.aspx?id={0}&type=DLCDWMLQ&clss=ZX" />
                            <x:BoundField HeaderText="仓库数量" DataField="totnum" TextAlign="Center" />
    ...
    <x:Window ID="W_ShowSCF" Title="仓库信息" Popup="false" EnableIFrame="true" IFrameUrl="about:blank"
