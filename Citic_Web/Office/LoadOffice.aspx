<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadOffice.aspx.cs" Inherits="Citic_Web.Office.LoadOffice" %>
...
<head id="Head1" runat="server">
    <title>编辑正文</title>
    <!-- --------------------===  Weboffice初始化完成事件--------------------- -->
    <script language="javascript" for="WebOffice1" event="NotifyCtrlReady" type="text/javascript">
