...
namespace Citic.BLL
{
    ...
    {
        private readonly Citic.DAL.DBSX dal = new Citic.DAL.DBSX();
        public DBSX()
        { }
        #region  BasicMethod
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Citic.Model.DBSX GetModelByCache(int ID)
        {

            string CacheKey = "DBSXModel-" + ID;
            ...
            return (Citic.Model.DBSX)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Citic.Model.DBSX> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Citic.Model.DBSX> DataTableToList(DataTable dt)
        {
            List<Citic.Model.DBSX> modelList = new List<Citic.Model.DBSX>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Citic.Model.DBSX model;
